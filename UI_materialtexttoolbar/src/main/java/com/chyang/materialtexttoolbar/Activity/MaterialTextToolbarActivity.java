package com.chyang.materialtexttoolbar.Activity;
...
import com.chyang.materialtexttoolbar.R;

import java.util.ArrayList;
import java.util.List;

public class MaterialTextToolbarActivity extends AppCompatActivity implements AbsListView.OnScrollListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_text_toolbar);
    ...
    private void initListViewHeader() {
        View headerContainer = LayoutInflater.from(this).inflate(R.layout.screen_material_header, listView, false);
    ...
    public float getScrollY(AbsListView view) {
        ...
        System.out.println("-top:"+ top +" fistVisiblePosition: "+firstVisiblePosition + "   height:"+ c.getHeight() + "   headerHeight:" +headerHeight +"   result:" +offset) ;
        return offset;
    }
}
